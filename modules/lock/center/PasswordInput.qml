    ...
    RowLayout {
        ...
        Item {
            ...
            MaterialShape {
                ...
                color: root.lock.pam.buffer ? Colours.pick(Colours.palette.m3base0D, Colours.palette.m3primary) : Colours.layer(Colours.pick(Colours.palette.m3base03, Colours.palette.m3surfaceContainerHigh), 2)
