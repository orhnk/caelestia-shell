    ...
    RowLayout {
        ...
        ColumnLayout {
            ...
            StyledText {
                ...
                color: input.isError && root.errorText ? Colours.pick(Colours.palette.m3base08, Colours.palette.m3error) : Colours.pick(Colours.palette.m3base04, Colours.palette.m3outline)
