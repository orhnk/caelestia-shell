...
// Electron disables the PipeWire capturer by default. Without it,
// getDisplayMedia fails with NotReadableError ("Could not start video
// source") on Wayland, which breaks the Linux portal capture path.
